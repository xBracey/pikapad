...
const defaultButtonMap: Record<ButtonActions, number[]> = {
    escape: [1],
    rightClick: [2],
    swipeLeft: [4],
    swipeRight: [5],
...
export const getButtonMap = () => {
    ...
    return JSON.parse(buttonMap) as Record<ButtonActions, number[]>;
};

export const setButton = (button: number[], action: ButtonActions) => {
